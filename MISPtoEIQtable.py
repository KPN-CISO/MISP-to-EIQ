...
MISPtoEIQtable={
                ...
                'email-reply-to':{'eiqtype':types.OBSERVABLE_EMAIL,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_LOW,'indicator_types':[types.INDICATOR_MALICIOUS_EMAIL]},
                'email-src-display-name':{'eiqtype':types.OBSERVABLE_EMAIL,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_MEDIUM,'indicator_types':[types.INDICATOR_MALICIOUS_EMAIL]},
                'email-dst-display-name':{'eiqtype':types.OBSERVABLE_EMAIL,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_LOW,'indicator_types':[types.INDICATOR_MALICIOUS_EMAIL]},
                'target-email':{'eiqtype':types.OBSERVABLE_EMAIL,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_LOW,'indicator_types':[types.INDICATOR_MALICIOUS_EMAIL]},
                ...
                'github-repository':{'eiqtype':types.OBSERVABLE_URI,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_LOW,'indicator_types':[types.INDICATOR_URL_WATCHLIST]},
                ...
                'github-organisation':{'eiqtype':types.OBSERVABLE_ORGANIZATION,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_LOW,'indicator_types':[types.INDICATOR_URL_WATCHLIST]},
                'iban':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'bic':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'bank-account-nr':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'btc':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'bin':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'aba-rtn':{'eiqtype':types.OBSERVABLE_BANK_ACCOUNT,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'cc-number':{'eiqtype':types.OBSERVABLE_CARD,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'prtn':{'eiqtype':types.OBSERVABLE_TELEPHONE,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_HIGH},
                'nationality':{'eiqtype':types.OBSERVABLE_NATIONALITY,'classification':types.CLASSIFICATION_UNKNOWN},
                'passport-country':{'eiqtype':types.OBSERVABLE_NATIONALITY,'classification':types.CLASSIFICATION_UNKNOWN},
                'country-of-residence':{'eiqtype':types.OBSERVABLE_COUNTRY,'classification':types.CLASSIFICATION_UNKNOWN},
                'target-user':{'eiqtype':types.OBSERVABLE_PERSON,'classification':types.CLASSIFICATION_GOOD},
                'target-org':{'eiqtype':types.OBSERVABLE_ORGANIZATION,'classification':types.CLASSIFICATION_GOOD},
                'target-external':{'eiqtype':types.OBSERVABLE_ORGANIZATION,'classification':types.CLASSIFICATION_GOOD},
                'whois-registrant-email':{'eiqtype':types.OBSERVABLE_PERSON,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_MEDIUM},
                'whois-registrant-phone':{'eiqtype':types.OBSERVABLE_TELEPHONE,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_MEDIUM},
                'whois-registrant-name':{'eiqtype':types.OBSERVABLE_PERSON,'classification':types.CLASSIFICATION_BAD,'confidence':types.CONFIDENCE_MEDIUM},
}
